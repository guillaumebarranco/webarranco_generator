...
class UtilsClass {
	...
	generateNewReactApp(appName) {
		...
		console.log('sudo npm install -g react-cli react create-react-project && create-react-project '+appName);

		// executes `pwd`
		child = exec('sudo npm install -g react-cli react create-react-project && create-react-project '+appName, function (error, stdout, stderr) {
	...
	generateNewAngularApp(appName) {
		...
		console.log('------ Type the following commands ------');
		console.log('npm install -g @angular/cli && ng new '+appName);
	}
	...
	geneteNewExpressApp(appName) {
		...
		console.log('------ Type the following commands ------');
		console.log('npm install express-generator -g');
